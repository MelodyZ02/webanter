            ...
            <div class="profile-info ">
                <div class="panel">
                    ...
                    <div class="panel-body bio-graph-info">
                        ...
                        <div class="row">
                            <div class="bio-row">
                                <p><span style="font-weight: bold"><?= $lang['name'] ?> :</span> <?= $fetch['name'] ?></p>
                            </div>
                            <div class="bio-row">
                                <p><span style="font-weight: bold">User ID :</span> <?= $fetch['userID'] ?></p>
                            </div>
                            <div class="bio-row">
                                <p><span style="font-weight: bold"><?= $lang['profileImage'] ?> :</span> <br><?= $fetch['profileIMG'] ?></p>
                            </div>
                            <div class="bio-row">
                                <p><span style="font-weight: bold"><?= $lang['profileGender'] ?> :</span> <?= $fetch['gender'] == 0 ? $lang['female'] : $lang['male']?></p>
                            </div>
                            <div class="bio-row">
                                <p><span style="font-weight: bold">Email :</span> <?= $fetch['email'] ?></p>
                            </div>
                            <div class="bio-row">
                                <a href="profileEdit.php"><button class="bn632-hover bn22" ><?= $lang['profileEdit'] ?></button></a>
                            </div>
                        </div>
                    </div>
                </div>
