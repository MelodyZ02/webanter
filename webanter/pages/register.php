                        ...
                        <div class="card-body p-5">
                            ...
                            <form>
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" id="name" class="form-control form-control-lg" placeholder="<?= $lang['form1'] ?>" />
                                    <br>
                                </div>

                                <div class="form-outline mb-4">
                                    <input type="email" id="email" class="form-control form-control-lg" placeholder="<?= $lang['form2'] ?>" />
                                    <br>
                                </div>

                                <div class="form-outline mb-4">
                                    <input type="password" id="pass" class="form-control form-control-lg" placeholder="<?= $lang['form3'] ?>" />
                                    <br>
                                </div>

                                <div class="form-outline mb-4">
                                    <input type="password" id="pass2" class="form-control form-control-lg" placeholder="<?= $lang['form4'] ?>" />
                                    <br>
                                </div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <button class="btn btn-lg btn-dark btn-block" type="submit"><?= $lang['register'] ?></button>
                                </div>
